...
public class ExemploOrdenacaoMap {
    public static void main(String[] args) {
        ...
        System.out.println("--\tOrdem número de página\t--"); //Pra você
             Set<Map.Entry<String, Livro>> meusLivrosPorPagina = new TreeSet<>(new ComparatorNumeroPagina() ) ;
             meusLivrosPorPagina.addAll(meusLivros.entrySet()
             ) ;
       /* System.out.println(meusLivrosPorPagina);*/
        for (Map.Entry<String, Livro> livro : meusLivrosPorPagina)
