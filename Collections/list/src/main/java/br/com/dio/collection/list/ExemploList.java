...
//      List<Double> notas = new ArrayList<>(Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6));
        ...
        notas.add(10d); (Vai dar erro porque não pode adicionar elementos)
...
*/
        ...
        System.out.println("Mostre a primeira nota da nova lista removendo-o: " + ((LinkedList<Double>) notas2).removeFirst());
